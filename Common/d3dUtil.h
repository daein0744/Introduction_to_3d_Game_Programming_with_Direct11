...
#include <DirectXMath.h> // xnamath 대체
#include <DirectXPackedVector.h> // xnamath 대체
#include "dxerr.h"
#include <cassert>
#include <ctime>
#include <algorithm>
...
public:
	...
	///</summary>
	static inline DirectX::PackedVector::XMCOLOR ToXmColor(FXMVECTOR v)
	{
	...
	///</summary>
	static inline DirectX::XMFLOAT4 ToXmFloat4(FXMVECTOR v)
	{
